...
module Icons
  # The ORCID iD logo. Sizing/alignment come from the shared `.orcid-icon` rule.
  class OrcidComponent < Blacklight::Icons::IconComponent
    self.svg = <<~SVG
      <svg xmlns="http://www.w3.org/2000/svg" class="orcid-icon" viewBox="0 0 256 256">
